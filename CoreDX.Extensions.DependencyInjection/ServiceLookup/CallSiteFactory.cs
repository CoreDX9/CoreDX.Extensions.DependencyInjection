    ...
    internal sealed partial class CallSiteFactory : IServiceProviderIsService, IServiceProviderIsKeyedService
    {
        ...
        private void Populate()
        {
            foreach (ServiceDescriptor descriptor in _descriptors)
            {
                ...
                else if (serviceType.IsGenericTypeDefinition)
                {
                    ...
                    if (TypedImplementationFactoryServiceProvider.VerifyOpenGenericServiceTrimmability)
                    {
        ...
        private ServiceCallSite? TryCreateEnumerable(ServiceIdentifier serviceIdentifier, CallSiteChain callSiteChain)
        {
            ...
            try
            {
                ...
                if (TypedImplementationFactoryServiceProvider.VerifyAotCompatibility && itemType.IsValueType)
                {

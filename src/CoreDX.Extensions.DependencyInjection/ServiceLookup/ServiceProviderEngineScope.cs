...
namespace CoreDX.Extensions.DependencyInjection.ServiceLookup
{
    ...
    internal sealed class ServiceProviderEngineScope : IServiceScope, IServiceProvider, IKeyedServiceProvider, IAsyncDisposable, IServiceScopeFactory
    {
        ...
        public ServiceProviderEngineScope(TypedImplementationFactoryServiceProvider provider, bool isRootScope)
        {
        ...
        internal TypedImplementationFactoryServiceProvider RootProvider { get; }

...
namespace CoreDX.Extensions.DependencyInjection.ServiceLookup
{
    internal sealed class ExpressionResolverBuilder : CallSiteVisitor<object?, Expression>
    {
        ...
        public ExpressionResolverBuilder(TypedImplementationFactoryServiceProvider serviceProvider)
        {
        ...
        protected override Expression VisitIEnumerable(IEnumerableCallSite callSite, object? context)
        {
            ...
            {
                Debug.Assert(!TypedImplementationFactoryServiceProvider.VerifyAotCompatibility || !elementType.IsValueType, "VerifyAotCompatibility=true will throw during building the IEnumerableCallSite if elementType is a ValueType.");

...
{
    /// <summary>
    /// The typed implementation factory supported IServiceProvider.
    /// </summary>
    [DebuggerDisplay("{DebuggerToString(),nq}")]
    [DebuggerTypeProxy(typeof(ServiceProviderDebugView))]
    public sealed class TypedImplementationFactoryServiceProvider : IServiceProvider, IKeyedServiceProvider, IDisposable, IAsyncDisposable
    {
        ...
        internal TypedImplementationFactoryServiceProvider(ICollection<ServiceDescriptor> serviceDescriptors, ServiceProviderOptions options)
        {
        ...
        {
            private readonly TypedImplementationFactoryServiceProvider _serviceProvider;

            public ServiceProviderDebugView(TypedImplementationFactoryServiceProvider serviceProvider)
            {
